  ...
  return (
    <aside className="w-[268px] shrink-0 border-l border-border-base overflow-y-auto bg-parchment-mid dark:bg-espresso">
            ...
            className={cn(
              ...
              delta > 0
                ...
                : delta < 0
                  ...
                  : "bg-border-base text-text-faint",
            )}
          >
      ...
      <div className="px-5 py-4 border-b border-border-base">
        ...
        {topTypes.length === 0 ? (
          <p className="text-[11px] text-text-faint">No data yet</p>
        ) : (
          <div className="space-y-2.5">
            {topTypes.map(([type, count]) => (
              <div key={type} className="flex items-center gap-2">
                ...
                <span className="text-[11px] text-text-faint w-4 text-right shrink-0">
                  {count}
                </span>
              </div>
            ))}
          ...
          <div className="space-y-2.5">
            {topSectors.map(([sector, count], i) => (
              <div key={sector} className="flex items-center gap-2">
                ...
                <span className="text-[11px] text-text-faint shrink-0">{count}</span>
              </div>
            ))}
          </div>
        )}
      ...
      <div className="px-5 py-4">
        ...
        {largestDeals.length === 0 ? (
          <p className="text-[11px] text-text-faint">No valued deals yet</p>
        ) : (
          <div>
