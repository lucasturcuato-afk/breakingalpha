    ...
    <div data-parity="ledger" style={{ backgroundColor: "var(--c-bg)", minHeight: "100%", padding: `0 ${PAD}` }}>
      ...
      <div style={{ padding: `0 ${PAD}` }}>
        ...
        {/* THE WRITE BAND. A permanent 52px shelf carrying the one write
            ...
            present at first paint, at scrollTop 0, at maximum scroll and after
            a client-side navigation, and sticky is already all four. There is
            nothing to reduce, so the prefers-reduced-motion block in
            ledger.module.css is untouched and this band is trivially correct
            under it.
        ...
        <div
          style={{
            ...
            zIndex: 1,
            height: "52px",
            /* Escapes BOTH horizontal paddings, the root's `0 20px` and this
               column's `0 20px`, so the band and its top rule span the full
               width rather than floating inside a 40px inset. */
            margin: `0 calc(-2 * ${PAD})`,
