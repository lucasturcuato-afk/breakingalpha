    ...
    >
      ...
      {cells.map((c) => (
        ...
        >
          ...
          <span className="font-data" style={{ fontSize: 13, color: "var(--espresso)", fontWeight: 600 }}>
            {c.valueText}
          </span>
          {c.tag ? (
...
function FigureCell({ figure }: { figure: MacroFigure }) {
  ...
  return (
    <span style={{ display: "inline-flex", alignItems: "baseline", gap: 5, whiteSpace: "nowrap" }}>
      ...
      <span className="font-data" style={{ fontSize: 12.5, color: "var(--espresso)", fontWeight: 600 }}>
