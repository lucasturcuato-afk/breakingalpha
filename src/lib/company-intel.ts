...
REQUIREMENT -- when any of the above is present in the pool, the memo MUST surface it. Surfacing is satisfied by at least one of:
  ...
  (b) the bear-case or "If [opposite condition]" clause of a What To Watch bullet naming the specific risk, OR
...
- INFORMATIONAL ONLY (no reader-directed advice): this brief describes and analyzes, it never instructs the reader. Banned everywhere in the memo: reader-directed recommendations and exposure or sizing guidance on any named security -- "recommend", "buy", "sell", "increase exposure", "reduce exposure", "overweight", "underweight", "trim", "add to position", "take profits", "you should". State what a development or scenario means for the thesis, never what the reader should do about it.
- VOICE REGISTER (institutional, never personal): ALL first person is banned everywhere in the memo, singular and plural alike -- never "I", "me", "my", "we", "us", "our", "ours", "I believe", "we think", "we see", "we expect", "we recommend", "in our view". Do not use the institutional "we": it is banned with the same force as "I". Default to active third person with a named actor, filing, metric, or event as the grammatical subject ("The order book points to...", "A delayed review weakens the thesis."). Where a stance needs an owner, attribute it to a named piece of sourced evidence ("The filing argues for...", "Filings put..."), never to a first-person voice. Passive-voice hedging ("it is believed", "it is expected that", "the thesis will be confirmed" with no named confirmer) is banned with the same force: every stance is owned by a named actor or a named piece of evidence. This rule governs pronouns and stance ownership only; it does not relax the opening rules, the banned-phrase list, or the unhedged verdict and probability formats.
...
**What To Watch**
Two bullets. This section is scenario analysis stated impersonally: it describes what each outcome would mean for the THESIS, never what the reader should do. Each bullet uses this structure: "If [specific trigger]: [what it confirms or breaks in the thesis]. If [opposite condition]: [why the thesis weakens]." Do not direct the reader to take any action and do not reference exposure, positioning, or sizing. Banned in this section without exception: "recommend", "buy", "sell", "increase exposure", "reduce exposure", "overweight", "underweight", "trim", "add to position", "take profits", "you should", and all first person ("we", "us", "our", "I", "my"). At least one bullet must name the specific catalyst or event that would change the signal quality from context-led to developments-led. Each bullet must commit to a position on whether that catalyst is likely, and why. Each bullet must be under 75 words. State the trigger and the thesis implication in the first two sentences. State probability in the third sentence. Stop.
