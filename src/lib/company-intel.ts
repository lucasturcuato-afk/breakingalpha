...
Draw exclusively from COMPANY DEVELOPMENT ARTICLES. For each development, apply this filter: does it involve a specific dollar figure, a named strategic counterparty, a named product with a deployment status, or a direct change to capital structure or competitive position? If yes, cover with two-sentence discipline. If no, omit. Cap at the 3-5 highest-density developments. Emit one element of lead.paragraphs per development; do NOT collapse multiple developments into a single string.
