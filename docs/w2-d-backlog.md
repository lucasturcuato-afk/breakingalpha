...
| WD07 | Sentiment chip contrast on /morning-brief and /evening-wrap | XS | None | P1 | NEUTRAL/BULLISH/BEARISH chips low contrast on espresso card. P2 carryover from prior session, promoted to P1 due to user-facing visibility. |
